...
def render_chatbot():
    ...
    .chat-history-container .stChatMessage {
        word-wrap: break-word; overflow-wrap: break-word; white-space: pre-wrap; margin-bottom: 10px;
    }
    .chat-history-container .stChatMessage p {
        word-wrap: break-word; overflow-wrap: break-word; white-space: pre-wrap; line-height: 1.5;
    }
